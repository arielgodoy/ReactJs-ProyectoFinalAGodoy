                    ...
                    <Col lg={8}>
                      <div className="p-5">
                        <div className="d-flex justify-content-between align-items-center mb-5">
                          <h1 className="fw-bold mb-0 text-black">Carrito de Compra</h1>
                          <h6 className="mb-0 text-muted">{cantidadEnCarrito()} items</h6>
                        </div>
                        <hr className="my-4" />
                        ...
                        <div className="pt-5">
                          <h6 className="mb-0">
                            <a href="#!" className="text-body">
                              <i className="fas fa-long-arrow-alt-left me-2"></i>Volver al Inicio
                            </a>
                          </h6>
                        </div>
                      </div>
                    ...
                    <Col lg={4} className="bg-grey">
                      <div className="p-5">
                        ...
                        <div className="d-flex justify-content-between mb-4">
                          <h5 className="text-uppercase">items {cantidadEnCarrito()}</h5>
                        ...
                        <h5 className="text-uppercase mb-3">Código Promoción</h5>

                        <div className="mb-5">
                          <div className="form-outline">
                            <Form.Control type="text" id="form3Examplea2" className="form-control form-control-lg" />
                            <label className="form-label" htmlFor="form3Examplea2">ingrese Código</label>
                          </div>
                        </div>
